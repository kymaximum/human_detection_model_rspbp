...
print("Input limit (number of people)")
lim_in = input()
lim_in = int(lim_in)
...
#       cv2.imshow("VideoFrame_original", frame)
        ...
        import psycopg2
        connection = psycopg2.connect(host="192.168.0.12", dbname="kyra_database", user="postgres", password="tonycoding", port="5432")
        cur = connection.cursor()

        cur.execute("INSERT INTO public.\"People\"(numppl, lim, status, t) VALUES(%s, %s, %s, '%s')", (int(num_objects), lim_in, status_input, output_time))
